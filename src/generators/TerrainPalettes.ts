...
// Winter: muted, gray-green, desaturated, snowy tinge
const PALETTES_WINTER: Record<TerrainType, TerrainPalette> = {
  ...
  coast:    { base: [0x607858, 0x708868, 0x809878, 0x90a888, 0xa0b898], detailFreq: 0.15, detailAmp: 0.6 },
  lowland:  { base: [0x506848, 0x5c7854, 0x688860, 0x749870, 0x80a880], detailFreq: 0.18, detailAmp: 0.7 },
  highland: { base: [0x485c40, 0x546c4c, 0x607858, 0x6c8864, 0x789470], detailFreq: 0.14, detailAmp: 0.6 },
